...
public class VirtualAccountMessage implements Message {
    ...
    public static VirtualAccountMessage parse(Header header, MessageReader reader) throws EOFException, IOException {
        ...
        instance.acco_code = new String(reader.read(6));
        ...
        instance.seq_no = new String(reader.read(10));
        ...
        instance.filler_1 = new String(reader.read(27));
        ...
        instance.in_bank_cd = new String(reader.read(6));
        ...
        instance.filler_2 = new String(reader.read(header.getLength() - reader.getPreface().length));
        return instance;
    }
